      ...
      <div className="mt-auto pt-7">
        <Link
          ...
          className={cn(
            ...
            featured
              ? "inline-block rounded-btn bg-accent px-5 py-3 font-bold text-on-accent transition-colors duration-200 ease-out group-hover:bg-accent-deep focus-visible:rounded-btn"
